...
@section('title', 'Add Slider | AWJU Admin')
@section('content')
    ...
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.slider.store')}}" enctype="multipart/form-data"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title_pa" id="title_pa" placeholder="د ښځو په هکله بیړنی خبرونه"
                        type="text" class="form-control" value="{{old('title_pa')}}" required maxlength="190">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="subtitle_pa" id="subtitle_pa" placeholder="د تر ټولو موثق سرچینو څخه"
                        type="text" class="form-control" value="{{old('subtitle_pa')}}" required maxlength="190">

...
@section('title', 'Add Partner | AWJU Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="fa fa-plus icon-gradient bg-malibu-beach"></i>
            </div>
            <div>Add Partner
        ...
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="{{route('admin.partner.index')}}" type="button" class="btn-shadow btn btn-info"
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.partner.store')}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            <div class="position-relative row form-group">
                <label for="title" class="col-sm-2 col-form-label">Title</label>
                <div class="col-sm-10">
                    <input name="title" id="title" placeholder="USAID" type="text" class="form-control" value="{{old('title')}}" required maxlength="191">

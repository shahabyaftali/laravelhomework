...
@section('title', 'Edit Blog | AWJU Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Edit Blog
                <div class="page-title-subheading">Fill the following form to edit the blog</div>
            </div>
        </div>
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="{{route('admin.blog.index')}}" type="button" class="btn-shadow btn btn-info" style="font-weight: bold;">
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.blog.update', $blog)}}"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <select name="language" id="language" class="form-control">
                      ...
                      <option value="ps" {{$blog->language == 'ps' ? 'selected' : ''}}>پښتو</option>
                      <option value="fa" {{$blog->language == 'fa' ? 'selected' : ''}}>دری</option>
                    </select>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title" id="title" placeholder="Women's day celebration" type="text" class="form-control" value="{{$blog->title}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description" id="description" class="form-control tiny" required>{{$blog->description}}</textarea>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-4">
                    <img src="{{asset('storage/images/blog/' . $blog->image)}}" alt="Gallery image"

...
@section('title', 'Add Blog | AWJU Admin')
@section('content')
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.blog.store')}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title" id="title" placeholder="What this blog is about" type="text" class="form-control" value="{{old('title')}}" required maxlength="191">

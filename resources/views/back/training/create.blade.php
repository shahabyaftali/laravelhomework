...
@section('title', 'Add Training | AWJU Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Add Training
                <div class="page-title-subheading">Fill the following form to add a training</div>
            </div>
        </div>
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="{{route('admin.training.index')}}" type="button" class="btn-shadow btn btn-info"
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.training.store')}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title" id="title" placeholder="Teaching Photography" type="text" class="form-control" value="{{old('title')}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="video" id="video" placeholder="youtube embedded link" type="text" class="form-control" value="{{old('video')}}" required>

...
@section('title', 'Edit News | AWJU Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Edit News
                <div class="page-title-subheading">Fill the following form to edit the news</div>
            </div>
        </div>
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="{{route('admin.news.index')}}" type="button" class="btn-shadow btn btn-info" style="font-weight: bold;">
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.news.update', $news)}}"
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <select name="language" id="language" class="form-control">
                      <option value="en" {{$news->language == 'en' ? 'selected' : ''}}>English</option>
                      <option value="ps" {{$news->language == 'ps' ? 'selected' : ''}}>پښتو</option>
                      <option value="fa" {{$news->language == 'fa' ? 'selected' : ''}}>دری</option>
                    </select>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title" id="title" placeholder="Women's day celebration" type="text" class="form-control" value="{{$news->title}}" required maxlength="191">
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="description" id="description" class="form-control tiny" required>{{$news->description}}</textarea>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-4">
                    <img src="{{asset('storage/images/news/' . $news->image)}}" alt="Gallery image"

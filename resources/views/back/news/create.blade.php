...
@section('title', 'Add News | AWJU Admin')
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Add News
                <div class="page-title-subheading">Fill the following form to add a news</div>
            </div>
        </div>
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="{{route('admin.news.index')}}" type="button" class="btn-shadow btn btn-info"
...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <form id="signupForm" method="post" action="{{route('admin.news.store')}}" enctype="multipart/form-data" novalidate="novalidate">
        @csrf
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input name="title" id="title" placeholder="What happened ..." type="text" class="form-control" value="{{old('title')}}" required maxlength="191">
